<%-- 
    Document   : editar_reg
    Created on : 13-abr-2021, 18:22:18
    Author     : Jorge
--%>
        ...
        <form action="Principal" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <%
                            if (reg.getStado_vacuna().equals("si")) {

                        %>
                        <input type="radio" name="stado" value="Si" checked>SI<br>
                        <input type="radio" name="estado" value="No">NO
                        <%                        } else {
                        %>
                        <input type="radio" name="stado" value="Si" >SI<br>
                        <input type="radio" name="stado" value="No" checked>NO
                        <%
                            }
                        %>
